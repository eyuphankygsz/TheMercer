...
public class HoldHands1 : MiniGames
{
    ...
    public override void MiniUpdate()
    {
        ...
        Vector2 limitWoman = new Vector2(Mathf.Clamp(_woman.anchoredPosition.x, 720, 1250), _woman.anchoredPosition.y);
        _woman.anchoredPosition = limitWoman;
    }
    private void CheckDone()
    {
        if (Vector2.Distance(_astro.anchoredPosition, _woman.anchoredPosition) < 1440)
        {
